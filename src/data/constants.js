...
export const skills = [
  ...
  },
  {
    ...
    skills: [
      {
        name: "Swift",
        image: "https://www.vectorlogo.zone/logos/swift/swift-icon.svg",
      },
      {
        name: "Android Studio",
        image:
...
export const experiences = [
  {
    ...
    desc: "I've played a pivotal role in the end-to-end project lifecycle, from initial stakeholder engagement to solution delivery, while ensuring adherence to professional standards. As the primary developer of a Claim Management System, I utilized React.js and Tailwind CSS to streamline claim submissions for company employees. Additionally, I served as Scrum Master and Product Owner, guiding Agile ceremonies and managing the product backlog to ensure timely feature delivery and alignment with business goals.",
    skills: [
      "HTML",
      "CSS",
      "JavaScript",
...
export const education = [
  {
    id: 0,
    img: "https://firebasestorage.googleapis.com/v0/b/profile-d71da.appspot.com/o/utar.jpeg?alt=media&token=ac57fa57-170f-4615-8edd-9b88ad9405f9",
...
export const projects = [
  {
    id: 0,
    title: "Pine Script v5 KY Strategy",
    date: "Apr 2023 - May 2023",
    description:
      "This Pine Script strategy, developed by me, embodies my unique trading approach, providing tailored buy and sell signals. Green arrows signify opportune moments for buying, offering entry points, while red arrows highlight favorable sell signals, suggesting potential exits. These signals reflect my expertise and can assist traders in making informed decisions and managing positions effectively. As always, comprehensive analysis and prudent risk management are essential in navigating the inherent risks associated with trading.",
    image:
      "https://firebasestorage.googleapis.com/v0/b/profile-d71da.appspot.com/o/kyscript.png?alt=media&token=83e7bc2d-49a0-4c6f-b9bd-363d1d838c98",
    tags: ["Pine Script"],
